...
def test_remove_expense_reduces_total():
    ...
    service.create_expense("Libro", 20, "Cultura", date.today())
    service.create_expense("Revista", 5, "Ocio", date.today())

    first_id = service.list_expenses()[0].id
    service.remove_expense(first_id)
